...
function Movie({ result }: MovieProps) {
    ...
    <>
      ...
      {!session ? (
        ...
        <section className='relative z-50'>
          ...
          <div className='absolute inset-y-28 md:inset-y-auto md:bottom-10 inset-4 md:inset-x-12 space-y-6 z-50'>
            ...
            <div className='flex items-center space-x-3 md:space-x-5'>
              ...
              <div
                className='rounded-full border-2 border-white flex items-center justify-center w-11 h-11 
...
export const getServerSideProps: GetServerSideProps<Props> = async (
  ...
  const request = await fetch(`https://api.themoviedb.org/3/movie/${id}
  ?api_key=${process.env.NEXT_PUBLIC_API_KEY}&language=en-US&append_to_response=videos`).then(
